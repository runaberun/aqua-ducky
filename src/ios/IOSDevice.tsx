...
// Current device time as iOS shows it ("9:41", 12-hour, no meridiem), ticking each minute.
...
// ------------------------------------------------------------------
//  Simplified iOS 26 device frame (dark) — ported from ios-frame.jsx.
//  Only the pieces the water app needs: bezel, status bar, dynamic
